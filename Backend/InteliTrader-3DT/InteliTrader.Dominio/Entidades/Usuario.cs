        ...
        public Usuario(string nome, string sobrenome, string email, string senha, string rg, string cpf, string telefone, string descricao, string cursando, string instituicao, string trabalho, string ondeTrabalha, EnTipoUsuario tipoUsuario)
        {
            AddNotifications(
                  new Contract<Notification>()
                      ...
                      .IsLowerOrEqualsThan(senha, 8, "Senha", "A senha deve ter 8 caracteres ou mais")
                      .IsLowerOrEqualsThan(telefone, 11, "Telefone", "O Telefone deve ter 11 caracteres")
                      .IsLowerOrEqualsThan(rg, 9, "RG", "O RG deve ter 10 caracteres")
                      .IsLowerOrEqualsThan(cpf, 11, "CPF", "O CPF deve ter 11 caracteres")
