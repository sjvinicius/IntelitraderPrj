...
namespace InteliTrader.Dominio.Commands.Usuario
{
    public class CriarContaCommand : Notifiable<Notification>, ICommand
    {
        ...
        public CriarContaCommand(string nome, string sobrenome, string email, string senha, string rg, string cpf, string telefone, string descricao, string cursando, string instituicao, string trabalho, string ondeTrabalha, EnTipoUsuario tiposUsuario)
        {
            Nome = nome;
            Sobrenome = sobrenome;
            Email = email;
        ...
        public void Validar()
        {
            ...
            new Contract<Notification>()
                ...
                .IsGreaterThan(RG, 8, "RG", "O RG deve ter 9 caracteres")
